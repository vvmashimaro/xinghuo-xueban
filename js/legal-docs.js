...
(function (global) {
  ...
  var SERVICE_HTML =
    DEMO_BANNER +
    '<p class="text-[11px] text-slate-500">版本：v1.0 · 更新日期：2026年9月23日</p>' +
    '<p class="text-slate-800 font-bold">第一条 定义</p>' +
    '<p>1. <strong>平台 / 「星火学伴」</strong>：指由成都励德科技发展有限公司运营的课业辅导撮合、预约调度、资金托管对接及可选智能教学微空间（IoT 教学仓）相关技术服务系统。</p>' +
    ...
    '<p>一方违反本协议给对方或平台造成损失的，应依法承担责任。争议应先行协商；协商不成可向客服提交证据请求协调；仍无法解决的，提交成都励德科技发展有限公司住所地有管辖权的人民法院诉讼解决。</p>' +
    ...
    '<p>3. 联系方式：客服邮箱 support@xinghuo-xueban.com、客服电话待填。</p>';

  var PRIVACY_HTML =
    DEMO_BANNER +
    '<p class="text-[11px] text-slate-500">版本：v1.0 · 更新日期：2026年9月23日 · 文中「反洗钱与资金清算授权」为政策专节，登录页统一以《个人信息保护政策》指称。 +
    ...
    '<p>运营主体：成都励德科技发展有限公司；个人信息保护负责人/邮箱：privacy@xinghuo-xueban.com；客服电话：客服电话待填；联系地址：四川省成都市。一般情况下将在十五个工作日内回复。</p>';
